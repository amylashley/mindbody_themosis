...
{	
	 ...
	 * @return object The raw result of the SOAP call
	 */
	public function GetProducts($productIDs = array(), $searchText = null, $searchDomain = null , $categoryIDs = array(), $subCategoryIDs = array(), $sellOnline = false, $locationID = null,SourceCredentials $credentials = null, $XMLDetail = XMLDetail::Full, $PageSize = NULL, $CurrentPage = NULL, $Fields = NULL)
	{
